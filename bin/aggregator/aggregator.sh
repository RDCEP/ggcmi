...
swift -sites.file midway.xml -tc.file tc.data aggregator.swift \
      ...
      -a=/project/ggcmi/AgMIP.output/processed/masks/aggr/gadm0.mask.nc4,/project/ggcmi/AgMIP.output/processed/masks/aggr/fpu.mask.nc4,/project/ggcmi/AgMIP.output/processed/masks/aggr/kg.mask.nc4,/project/ggcmi/AgMIP.output/processed/masks/aggr/global.mask.nc4 \
      ...
      -o=/project/ggcmi/AgMIP.output/processed/aggs/gadm0,/project/ggcmi/AgMIP.output/processed/aggs/fpu,/project/ggcmi/AgMIP.output/processed/aggs/kg,/project/ggcmi/AgMIP.output/processed/aggs/global
