...
app (file o) cleanlongisi1 (string model, string gcm, string crop, string co2, string rcp) {
   cleanlongisi1 model gcm crop co2 rcp stdout = @o;
}
      ...
      foreach c in crops {
         foreach co in co2s {
            foreach r in rcps {
               ...
               logfile = cleanlongisi1(m, g, c, co, r);
            }
         }
      }
   }
